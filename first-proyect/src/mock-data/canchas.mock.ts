...
export const mockCanchas: CanchaProps[] = [
    ...
    { id: 2, nombre: 'Cancha Lateral A', tipo: 'Fútbol', precioHora: 18000, capacidad: 14, imagenUrl: 'https://pastojansen.cl/wp-content/uploads/2018/08/PORTAFOLIO1.png', descripcion: 'Cancha de arcilla con iluminación para 7 jugadores.', fotos: ['https://i.imgur.com/N8g1r7l.png'] },
