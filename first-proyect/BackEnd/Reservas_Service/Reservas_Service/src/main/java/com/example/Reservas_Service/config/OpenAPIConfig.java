...
public class OpenAPIConfig {
    ...
    public OpenAPI reservasServiceAPI() {
        ...
        server.setUrl("/");
        server.setDescription("Reservas Service Server");
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .contact(contact)
                .description("Gestiona la creación, modificación y cancelación de reservas. Verifica disponibilidad con Canchas Service.");
